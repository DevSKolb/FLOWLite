...
class Cache {
         ...
         * @return string 
         */ 
        public function getFileName($sCacheName) { 
         ...
         */ 
        public function readCache($sCacheName) { 
         ...
         * @return boolean 
         */ 
        public function writeCache($sCacheName, $mData, $iLifetime = -1) {
         ...
         * @return boolean 
         */ 
        public function deleteCache($sCacheName, $bIsFileName = false) { 
				...
				if(file_exists($sFileName)) return @unlink($sFileName);
