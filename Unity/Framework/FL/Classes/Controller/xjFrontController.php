...
#	   if( NameSpaces::classExistsInApplication($this->controller))
#	   {
#
include 'C:/xampp/htdocs/FLOWLite_xy/Classes/ActionController/AppControllerLocalepages.php';

$this->controller = new AppControllerLocalepages();
$this->action = 'run';


#include 'C:/xampp/htdocs/FLOWLite_xy/AppPages.php';
